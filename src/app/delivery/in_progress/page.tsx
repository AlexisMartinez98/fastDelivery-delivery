...
function DeliveryInProgress(){
    ...
    return(  <main className="mr-6 ml-6 mt-4 mb-8 font-poppins ">
    ...
    <div className="py-5 bg-[#ffffff] rounded-xl relative top-[-7px] flex flex-col items-center ">
        ...
        <div className="my-5 w-[90%] text-[0.90rem] font-semibold text-[#3D1DF3] ">
            <p className="mt-1">Destino: <span className="font-light">Amenabar 2356, Caba</span></p>
            <p className="mt-1">Número de paquetes: <span className="font-light">#0A235</span></p>
            <p className="mt-1">Recibe: <span className="font-light">David Rodriguez</span></p>
        </div>
