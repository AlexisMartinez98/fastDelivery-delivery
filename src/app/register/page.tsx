        ...
        <div className="p-4 ">
          ...
          <div className="relative mb-3">
            <input
              type="text"
              id="name"
              className={`w-full h-12 rounded-2xl border-[1px] placeholder-[#3D1DF3] ${
                singUpForm.touched.name && singUpForm.errors.name
                  ? "border-[red]"
                  : "border-[#3D1DF3]"
              } bg-transparent pl-5 text-[#3D1DF3]`}
              placeholder="Nombre"
              required
          ...
          <div className="relative ">
            <input
              ...
              id="confirm_password"
              className={`w-full h-12 rounded-2xl border-[1px] placeholder-[#3D1DF3] ${
                singUpForm.touched.confirm_password &&
                singUpForm.values.confirm_password !==
                  singUpForm.values.password
                  ? "border-[red]"
                  : "border-[#3D1DF3]"
              } bg-transparent pl-5 text-[#3D1DF3]`}
